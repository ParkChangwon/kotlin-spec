// Generated from /Users/changweonpark/Workspace/OpenSource/GitHubClones/kotlin-spec/grammar/src/main/antlr/FXMathLexer.g4 by ANTLR 4.13.1
package antlr;
...
public class FXMathLexer extends Lexer {
	...
	public static final int
		...
		RCURL=14, MULT=15, MOD=16, DIV=17, ADD=18, SUB=19, POWER=20, INCR=21, 
		DECR=22, CONJ=23, DISJ=24, EXCL_WS=25, EXCL_NO_WS=26, COLON=27, SEMICOLON=28, 
		ASSIGNMENT=29, ADD_ASSIGNMENT=30, SUB_ASSIGNMENT=31, MULT_ASSIGNMENT=32, 
		DIV_ASSIGNMENT=33, MOD_ASSIGNMENT=34, ARROW=35, DOUBLE_ARROW=36, RANGE=37, 
		RANGE_UNTIL=38, COLONCOLON=39, DOUBLE_SEMICOLON=40, HASH=41, AT_NO_WS=42, 
		AT_POST_WS=43, AT_PRE_WS=44, AT_BOTH_WS=45, QUEST_WS=46, QUEST_NO_WS=47, 
		LANGLE=48, RANGLE=49, LE=50, GE=51, EXCL_EQ=52, EXCL_EQEQ=53, AS_SAFE=54, 
		EQEQ=55, EQEQEQ=56, SINGLE_QUOTE=57, AMP=58, RETURN_AT=59, CONTINUE_AT=60, 
		BREAK_AT=61, THIS_AT=62, SUPER_AT=63, FILE=64, FIELD=65, PROPERTY=66, 
		GET=67, RECEIVER=68, PARAM=69, SETPARAM=70, DELEGATE=71, PACKAGE=72, IMPORT=73, 
		CLASS=74, INTERFACE=75, FUN=76, OBJECT=77, VAL=78, VAR=79, TYPE_ALIAS=80, 
		CONSTRUCTOR=81, BY=82, COMPANION=83, INIT=84, THIS=85, SUPER=86, TYPEOF=87, 
		WHERE=88, IF=89, ELSE=90, WHEN=91, TRY=92, CATCH=93, FINALLY=94, FOR=95, 
		DO=96, WHILE=97, THROW=98, RETURN=99, CONTINUE=100, BREAK=101, AS=102, 
		IS=103, IN=104, NOT_IS=105, NOT_IN=106, OUT=107, DYNAMIC=108, PUBLIC=109, 
		PRIVATE=110, PROTECTED=111, INTERNAL=112, ENUM=113, SEALED=114, ANNOTATION=115, 
		DATA=116, INNER=117, VALUE=118, TAILREC=119, OPERATOR=120, INLINE=121, 
		INFIX=122, EXTERNAL=123, SUSPEND=124, OVERRIDE=125, ABSTRACT=126, FINAL=127, 
		OPEN=128, CONST=129, LATEINIT=130, VARARG=131, NOINLINE=132, CROSSINLINE=133, 
		REIFIED=134, EXPECT=135, ACTUAL=136, NATURAL=137, INTEGER=138, NUMBER=139, 
		COMPLEX=140, COLLECTION=141, SET=142, ARRAY=143, MATRIX=144, ALPHA=145, 
		BETA=146, GAMMA=147, DELTA=148, EPSILON=149, OMEGA=150, INFINITY=151, 
		PI=152, PHI=153, THETA=154, SymbolName=155, SIN=156, COS=157, TAN=158, 
		SEC=159, COSEC=160, COT=161, LIM=162, D_D=163, INTEGRAL=164, TrigonometricFunctionName=165, 
		Number=166, HexLiteral=167, BinLiteral=168, BooleanLiteral=169, NullLiteral=170, 
		CharacterLiteral=171, Identifier=172, IdentifierOrSoftKey=173, FieldIdentifier=174, 
		QUOTE_OPEN=175, TRIPLE_QUOTE_OPEN=176, UNICODE_CLASS_LL=177, UNICODE_CLASS_LM=178, 
		UNICODE_CLASS_LO=179, UNICODE_CLASS_LT=180, UNICODE_CLASS_LU=181, UNICODE_CLASS_ND=182, 
		UNICODE_CLASS_NL=183, QUOTE_CLOSE=184, LineStrRef=185, LineStrText=186, 
		LineStrEscapedChar=187, LineStrExprStart=188, TRIPLE_QUOTE_CLOSE=189, 
		MultiLineStringQuote=190, MultiLineStrRef=191, MultiLineStrText=192, MultiLineStrExprStart=193, 
		Inside_Comment=194, Inside_WS=195, Inside_NL=196, ErrorCharacter=197;
	public static final int
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"LCURL", "RCURL", "MULT", "MOD", "DIV", "ADD", "SUB", "POWER", "INCR", 
			...
			"RANGE_UNTIL", "COLONCOLON", "DOUBLE_SEMICOLON", "HASH", "AT_NO_WS", 
			...
			"SUPER_AT", "FILE", "FIELD", "PROPERTY", "GET", "RECEIVER", "PARAM", 
			...
			"VARARG", "NOINLINE", "CROSSINLINE", "REIFIED", "EXPECT", "ACTUAL", "NATURAL", 
			"INTEGER", "NUMBER", "COMPLEX", "COLLECTION", "SET", "ARRAY", "MATRIX", 
			"ALPHA", "BETA", "GAMMA", "DELTA", "EPSILON", "OMEGA", "INFINITY", "PI", 
			"PHI", "THETA", "SymbolName", "SIN", "COS", "TAN", "SEC", "COSEC", "COT", 
			"LIM", "D_D", "INTEGRAL", "TrigonometricFunctionName", "DecDigit", "DecDigitNoZero", 
			"DecDigitOrSeparator", "Alphabet", "DecDigits", "DoubleExponent", "Number", 
			"HexDigit", "HexDigitOrSeparator", "HexLiteral", "BinDigit", "BinDigitOrSeparator", 
			"BinLiteral", "BooleanLiteral", "NullLiteral", "CharacterLiteral", "UnicodeDigit", 
			...
			"Inside_BooleanLiteral", "Inside_HexLiteral", "Inside_BinLiteral", "Inside_CharacterLiteral", 
			"Inside_NullLiteral", "Inside_Comment", "Inside_WS", "Inside_NL", "ErrorCharacter"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"';;'", "'#'", "'@'", null, null, null, null, "'?'", "'<'", "'>'", "'<='", 
			"'>='", "'!='", "'!=='", "'as?'", "'=='", "'==='", "'''", "'&'", null, 
			null, null, null, null, "'file'", "'field'", "'property'", "'get'", "'receiver'", 
			...
			"'crossinline'", "'reified'", "'expect'", "'actual'", "'natural'", "'integer'", 
			"'number'", "'complex'", "'collection'", "'set'", "'array'", "'matrix'", 
			"'alpha'", "'beta'", "'gamma'", "'delta'", "'epsilon'", "'omega'", "'infinity'", 
			"'pi'", "'phi'", "'theta'", null, "'sin'", "'cos'", "'tan'", "'sec'", 
			"'cosec'", "'cot'", "'lim'", "'d_d'", "'integral'", null, null, null, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"MULT", "MOD", "DIV", "ADD", "SUB", "POWER", "INCR", "DECR", "CONJ", 
			...
			"GET", "RECEIVER", "PARAM", "SETPARAM", "DELEGATE", "PACKAGE", "IMPORT", 
			...
			"EXPECT", "ACTUAL", "NATURAL", "INTEGER", "NUMBER", "COMPLEX", "COLLECTION", 
			"SET", "ARRAY", "MATRIX", "ALPHA", "BETA", "GAMMA", "DELTA", "EPSILON", 
			"OMEGA", "INFINITY", "PI", "PHI", "THETA", "SymbolName", "SIN", "COS", 
			"TAN", "SEC", "COSEC", "COT", "LIM", "D_D", "INTEGRAL", "TrigonometricFunctionName", 
			"Number", "HexLiteral", "BinLiteral", "BooleanLiteral", "NullLiteral", 
	...
	public FXMathLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "FXMathLexer.g4"; }
